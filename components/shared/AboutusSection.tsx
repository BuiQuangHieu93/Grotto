...
const AboutusSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full bg-[#13392c] py-10 md:py-20 px-4 gap-4">
      {/* First Column - Image and Text */}
      <div className="col-span-1 lg:col-span-2 flex flex-col overflow-hidden">
        <div className="relative flex-grow overflow-hidden w-full h-[250px] md:h-[300px] lg:h-[400px]">
          <Image
        ...
        <div className="mt-4 text-xl md:text-2xl lg:text-4xl font-semibold text-white">
      ...
      <div className="grid grid-rows-2 gap-4">
        ...
        <div className="md:-translate-y-[30px] lg:-translate-y-[59px]">
          <div className="relative flex-grow overflow-hidden w-full h-[250px] md:h-[300px] lg:h-[400px]">
            <Image
          ...
          <div className="mt-4 text-[#cccccc] text-sm md:text-base">
      ...
      <div className="flex flex-col overflow-hidden">
        <div className="relative overflow-hidden w-full h-[250px] md:h-[300px] lg:h-[350px]">
          <Image
