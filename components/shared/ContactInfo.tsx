...
const ContactInfo = () => {
  ...
  return (
    <div className="py-20 px-5 bg-[#e9e8e4]">
      <div className="p-5 font-semibold text-2xl sm:text-3xl md:text-4xl bg-[#ffffff] text-center mb-10 sm:mb-20">
        Contact
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between text-gray-800">
        <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-4">
          ...
          <p className="mb-6 text-[#666666] text-xs sm:text-sm">
          ...
          <div className="mb-4 flex items-start">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm">+01 0123 456 789</p>
            </div>
          </div>
          <div className="mb-4 flex items-start">
            <div className="w-5 sm:w-6 h-5 sm:h-6 mr-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm">admin@gmail.com</p>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div>
              <p className="font-semibold text-sm sm:text-base">Open Hours</p>
        ...
        <div className="w-full md:w-1/2 pl-0 md:pl-4">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Contact Form</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-gray-800 text-white rounded w-full sm:w-auto"
            >
              SEND MESSAGE
            </button>
          </form>
