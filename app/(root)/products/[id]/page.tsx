...
import CategoryRelated from "@/components/shared/CategoryRelated";
...
const Page = () => {
  ...
  return (
    <div className="flex flex-col bg-[#e9e8e4]">
      <div className="grid-cols-2 gap-6 px-5 py-20 hidden md:grid">
        ...
        <div className="flex flex-col space-y-4 lg:mr-32 lg:ml-20 sticky top-0 items-start h-[550px]">
        ...
        Buy it now
          ...
          <div className="text-sm text-[#333333] font-normal mt-4">
            ...
            <span
              ...
              className="underline text-[#666666] uppercase cursor-pointer"
            >
              {product?.category}
            </span>
          </div>
      ...
      <div className="grid md:hidden px-5 py-20">
        {product && (
          <>
            <div className="overflow-hidden">
              {/* Main Swiper for large images */}
              <div className="overflow-hidden h-[355px]">
                <Swiper
                  spaceBetween={10}
                  slidesPerView={1}
                  loop
                ...
                <Swiper spaceBetween={10} slidesPerView={3} loop>
                  {product.images.map((image, index) => (
                    <SwiperSlide
                      ...
                      onClick={() => handleThumbnailClick(index)} // On click, change the main image
                    >
                      <div className="w-full h-0 pb-[100%] relative">
                        <Image
                          src={image}
      ...
      {product && (
        <CategoryRelated category={product.category} id={product._id} />
      )}
    </div>
  );
};
